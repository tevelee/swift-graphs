...
@dynamicMemberLookup
public struct ResidualGraph<Graph: WholeGraphProtocol>: GraphProtocol where Graph.Node: Hashable, Graph.Edge: Weighted, Graph.Edge.Weight: Numeric {
    ...
    @usableFromInline var base: Graph
    ...
    @inlinable public init(base: Graph) {
        self.base = base
        self.flows = [:]
    }
