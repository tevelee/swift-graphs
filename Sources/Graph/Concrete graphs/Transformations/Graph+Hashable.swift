...
@dynamicMemberLookup
public struct HashableNodesGraph<Base: GraphProtocol, HashValue: Hashable>: GraphProtocol where Base.Node: Equatable {
...
extension GraphProtocol where Node: Equatable {
...
@dynamicMemberLookup
public struct HashableEdgesGraph<Base: GraphProtocol, HashValue: Hashable>: GraphProtocol where Base.Edge: Equatable {
...
extension GraphProtocol where Edge: Equatable {
