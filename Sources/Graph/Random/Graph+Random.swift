extension Graph {
    ...
    @inlinable public static func random<Algorithm: RandomGraphGeneration<Node, Edge>>(using algorithm: Algorithm) -> Graph<Node, Edge> {
...
public protocol RandomGraphGeneration<Node, Edge> {
    ...
    @inlinable func generateRandomGraph() -> Graph<Node, Edge>
}
