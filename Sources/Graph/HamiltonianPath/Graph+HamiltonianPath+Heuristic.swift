...
public struct HeuristicHamiltonianPathAlgorithm<Node: Hashable, Edge>: HamiltonianPathAlgorithm {
    ...
    public struct Heuristic {
        ...
        public let evaluate: (_ node: Node, _ path: [Node], _ graph: any WholeGraphProtocol<Node, Edge>) -> Double
        ...
        @inlinable public init(evaluate: @escaping (Node, [Node], any WholeGraphProtocol<Node, Edge>) -> Double) {
    ...
    @usableFromInline func constructEdges(
        from nodes: [Node],
        withCycle: Bool,
        graph: any WholeGraphProtocol<Node, Edge>
    ) -> [GraphEdge<Node, Edge>] {
