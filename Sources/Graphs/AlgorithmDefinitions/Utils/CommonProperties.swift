...
public enum DistanceProperty<Weight>: VertexProperty {
    /// The default distance: ``Cost/infinite``.
    @inlinable
    public static var defaultValue: Cost<Weight> { .infinite }
}

extension DistanceProperty: Sendable where Weight: Sendable {}
...
public enum PredecessorEdgeProperty<Edge>: VertexProperty {
    /// The default predecessor edge: `nil`.
    @inlinable
    public static var defaultValue: Edge? { nil }
}

extension PredecessorEdgeProperty: Sendable where Edge: Sendable {}
