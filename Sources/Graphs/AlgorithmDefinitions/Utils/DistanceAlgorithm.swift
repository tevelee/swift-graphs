...
public struct DistanceAlgorithm<Coordinate, Distance> {
    ...
    extension DistanceAlgorithm {
        ...
        @inlinable
        public static func euclidean<Vector: SIMD>(_ coordinate: @escaping (Coordinate) -> Vector) -> Self
        where Vector.Scalar: FloatingPoint, Distance == Vector.Scalar {
            .init { a, b in
        ...
        @inlinable
        public static func manhattan<Vector: SIMD>(_ coordinate: @escaping (Coordinate) -> Vector) -> Self
        where Vector.Scalar: FloatingPoint, Distance == Vector.Scalar {
            .init { a, b in
