    ...
    public struct LouvainCommunityDetectionAlgorithm<Graph: IncidenceGraph & VertexListGraph & EdgeListGraph>: CommunityDetectionAlgorithm
    ...
    extension CommunityDetectionAlgorithm {
        ...
        @inlinable
        public static func louvain<Graph: IncidenceGraph & VertexListGraph & EdgeListGraph>(resolution: Double = 1.0) -> Self
        where Self == LouvainCommunityDetectionAlgorithm<Graph>, Graph.VertexDescriptor: Hashable {
