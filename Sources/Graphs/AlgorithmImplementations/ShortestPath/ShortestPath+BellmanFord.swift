    ...
    extension ShortestPathAlgorithm {
        ...
        @inlinable
        public static func bellmanFord<Graph: IncidenceGraph & EdgeListGraph & VertexListGraph, Weight: AdditiveArithmetic>(
    ...
    >: ShortestPathAlgorithm, SingleSourceShortestPathAlgorithm
    where
