    ...
    extension ColoringAlgorithm where Color == Int {
        ...
        @inlinable
        public static func welshPowell<Graph: IncidenceGraph & VertexListGraph>() -> Self
        where Self == WelshPowellColoringAlgorithm<Graph, Int>, Graph.VertexDescriptor: Hashable {
            .init()
        }
    }
