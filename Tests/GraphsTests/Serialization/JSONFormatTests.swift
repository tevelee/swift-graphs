    ...
    struct JSONFormatTests {
        ...
        @Test func graphWithBothProperties() throws {
            ...
            let vertices = try #require(json["vertices"] as? [[String: Any]])
            ...
            let edgeProps = try #require(edges[0]["properties"] as? [String: Any])
        ...
        @Test func compactJSON() throws {
            ...
            let expected =
                ...
                + "\"vertices\":[{\"id\":\"v0\",\"properties\":{\"Label\":\"A\"}},"
                + "{\"id\":\"v1\",\"properties\":{\"Label\":\"B\"}}]}"
        ...
        @Test func disconnectedGraph() throws {
            ...
            let v1 = graph.addVertex()
            let v2 = graph.addVertex()
            _ = graph.addVertex()  // v3 is disconnected
            graph.addEdge(from: v1, to: v2)
